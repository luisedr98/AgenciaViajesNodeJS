...
CREATE DATABASE IF NOT EXISTS `agenciaviajes` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `agenciaviajes`;
...
CREATE TABLE IF NOT EXISTS `testimoniales` (
  ...
  `mensaje` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `correo` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla agenciaviajes.testimoniales: ~3 rows (aproximadamente)
DELETE FROM `testimoniales`;
INSERT INTO `testimoniales` (`id`, `nombre`, `mensaje`, `correo`) VALUES
	(1, 'Luis', 'Mi viaje fue el mejor', 'luisdominguez818@gmail.com'),
	(2, 'Eduardo', 'Recomiendo ir a Francia', 'luisdominguez818@gmail.com'),
	(3, 'Cristian', 'Inglaterra es maravillosa', 'cristian@correo.com');
